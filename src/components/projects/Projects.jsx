...
export default function Projects() {
    return (<div>
        ...
        <h2 className="text-2xl font-bold mb-2">Current Projects</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div title="Click for more information..." className="group p-4 border border-solid hover:border-amber-100 rounded  hover:shadow-md hover:scale-[1.02] transition-transform duration-200">
